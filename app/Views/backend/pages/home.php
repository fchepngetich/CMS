            ...
            <div class="rounded shadow card mb-5">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <form class="pull-right" id="closeForm<?= $ticket['id'] ?>" method="post" action="">
                                <input type="hidden" name="closeticket" value="<?= $ticket['id'] ?>">
                                <button type="button" class="btn btn-info" onclick="submitForm('closeForm<?= $ticket['id'] ?>')">Close Ticket</button>
                            </form>
                        </div>
                        <?php endif; ?>
        ...
        form.addEventListener('submit', function(event) {
            ...
            .then(data => {
                if (data.status === 1) {
                    ...
                    const userId = "<?php use App\Libraries\CIAuth; CIAuth::id() ?>";
